...
class RegistroTwoScreen extends GetWidget<RegistroTwoController> {
                                                                  ...
                                                                  child: Row(
                                                                      ...
                                                                      children: [
                                                                        Padding(
                                                                            padding:
                                                                                getPadding(bottom: 4),
                                                                            child: Text("msg".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtInterMedium14Pink800.copyWith(height: 1.00))),
                                                                        Container(
                                                                            margin:
                                                                                getMargin(top: 1),
                                                                            padding: getPadding(left: 7, top: 1, right: 7, bottom: 2),
                                                                            decoration: AppDecoration.txtFillPink800.copyWith(borderRadius: BorderRadiusStyle.txtCircleBorder9),
                                                                            child: Text("lbl".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtInterMedium14WhiteA700.copyWith(height: 1.00)))
                                                                      ])))
                                                        ]))),
                                            Align(
                                                alignment: Alignment.centerLeft,
