...
class AppStyle {
  ...
  static TextStyle txtMontserratSemiBold10Amber500 = TextStyle(
  ...
  static TextStyle txtMontserratRomanRegular14 = TextStyle(
    color: ColorConstant.gray600,
    fontSize: getFontSize(
      14,
    ),
  ...
  static TextStyle txtMontserratSemiBold10Gray600 = TextStyle(
    color: ColorConstant.gray600,
    fontSize: getFontSize(
      10,
    ),
